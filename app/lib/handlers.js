...
// create container ofr users submethods
handlers._users = {};


//Users post
// Req fields first name last name phone password tosAgreement
  ...
  if(firstName && lastName && phone && password && tosAgreement){
    ...
    _data.read('users',phone,function(err,data){
      if(err){
        ...
        if(hashedPassword){
          ...
          _data.create('users',phone,userObject,function(err){
            if(!err){
              ...
              console.log(err);
              callback(500,{'Error' : 'Coul not creat the new user'});
        ...
        callback(400,{'Error' : ' A user wth that phone number already exists'});
      }
    });
